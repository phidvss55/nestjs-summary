...
export abstract class IQuery {
  ...
  ): Nullable<Nullable<MovieRatingCountRecResult>[]> | Promise<Nullable<Nullable<MovieRatingCountRecResult>[]>>;

  abstract userGenreMovieCountRec(
    userName: string,
    limit?: Nullable<number>,
  ): Nullable<Nullable<UserGenreMovieCountRecResult>[]> | Promise<Nullable<Nullable<UserGenreMovieCountRecResult>[]>>;
}
