...
export class BaseRepository<T extends Document> {
  ...
  async findByCondition(filter: any, field?: any | null, option?: any | null, populate?: any | null): Promise<T> {
    const res = this.model.findOne(filter, field, option).populate(populate);
